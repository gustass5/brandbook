				...
				<section className="flex flex-col fontys-light items-center w-3/4 mx-auto">
					...
					<article className="flex flex-col text-lg space-y-6">
						...
						<p>
							...
							with static photos, this photo filter has been designed. The
							tab can be changed into the subject if the post, using the
							black or white background and the Fontys Fruitiger font.
						</p>
